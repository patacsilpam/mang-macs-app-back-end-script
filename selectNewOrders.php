...
WHERE tblorderdetails.order_status='Pending' OR tblorderdetails.order_status='Order Received'
 OR tblorderdetails.order_status='Order Processing' OR tblorderdetails.order_status='Ready for Pick Up' 
 OR tblorderdetails.order_status='Out for Delivery'  GROUP BY tblorderdetails.order_number 
 HAVING tblcustomerorder.email='$emailAddress' ORDER BY tblcustomerorder.order_number DESC");
$response = array();
