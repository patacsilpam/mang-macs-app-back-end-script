...
$selectNewOrders = $connect->query("SELECT tblcustomerorder.customer_name,tblcustomerorder.customer_address,
 ...
 tblorderdetails.price,tblorderdetails.quantity,tblorderdetails.add_ons,tblorderdetails.add_ons_fee,tblorderdetails.special_request,tblorderdetails.product_image, 
 tblorderdetails.order_type,tblorderdetails.order_status, tblcustomerorder.delivery_fee,tblcustomerorder.courier,
