<?php
    ...
    tblproducts.productImage,tblproducts.price,tblproducts.mainIngredients,tblproducts.stocks,tblproducts.code,
     ...
     FROM tbladdons  WHERE tbladdons.add_ons_category='Noodles' OR tbladdons.add_ons_category='Pancit') as 'add_ons',
     (SELECT GROUP_CONCAT(tbladdons.add_ons_price ORDER BY tbladdons.id ASC SEPARATOR ',') 
     FROM tbladdons  WHERE tbladdons.add_ons_category='Noodles' OR tbladdons.add_ons_category='Pancit') as 'add_ons_price'
    FROM `tbladdons` RIGHT JOIN tblproducts
    On tblproducts.productCategory = tbladdons.add_ons_category
    WHERE tblproducts.productCategory='Noodles' OR tblproducts.productCategory='Pancit'
